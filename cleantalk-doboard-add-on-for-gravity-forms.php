 ...
 * Description: Integrates Gravity Forms with doBoard, creates tasks in the doBoard task board for each submission of forms
 * Version: 1.1
...
define('CLEANTALK_DOBOARD_ADDON_FOR_GRAVITY_FORMS__VERISON', '1.1' );
